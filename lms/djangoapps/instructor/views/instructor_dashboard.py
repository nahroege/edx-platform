...
class InstructorDashboardTab(CourseTab):
    ...
    def is_enabled(cls, course, user=None):
        ...
        """
        return bool(user and user.has_perm('instructor.dashboard', course.id))
...
def instructor_dashboard_2(request, course_id):
    ...
    access = {
        ...
        'data_researcher': request.user.has_perm('instructor.research', course_key),
    }

    if not request.user.has_perm('instructor.dashboard', course_key):
        raise Http404()
